...
void display(void)
	{
		system("cls");
		cout<< "Displaing Records\n";
		cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"____________________"<<endl;
		cout<<"\"Book ID\""<<setw(30)<<"\"Book Name\""<<setw(30)<<"\"Author Name\""<<setw(30)<<"\"Category\""<<setw(30)<<"\"Publication\""<<setw(30)<<"\"Month of Publication\""<<setw(30)<<"\"Year of Publication\""<<endl;
		cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"____________________"<<endl;
		for(int i=0;i<n;i++)
			{
				cout<<books[i].bookid<<setw(30)<<books[i].bookname<<setw(30)<<books[i].authorname<<setw(30)<<books[i].bookcategory<<setw(30)<<books[i].bookpubcom<<setw(30)<<books[i].bookpubmonth<<setw(30)<<books[i].bookpubyear<<endl;
				cout<<"__________"<<"__________________________________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"______________________________"<<"____________________"<<endl;
			}
...
void add(void)
	{
		...
		do
		{
			...
			cout<<"Enter Book ID: ";
			gets(id1);
			books[n].bookid=atoi(id1);                          //converts the string input into integer value
			//cin.ignore();
...
void sbyname(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no book named ' "<<name<<" 'in the library"<<endl;
...
void sbyauthor(void)
	{
		...
		if(found == 0)
		{
            cout<<"there is no book written by ' "<<author<<" '"<<" in the library"<<endl;
            cout<<"Do you want to search again (Y/N)  ";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                search();
...
void sbyid(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no books with id ' "<<id<<" ' in the library"<<endl;
            cout<<"Do you want to search again (Y/N)";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                search();
...
void sbycategory(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no books with category ' "<<category<<" ' in the library"<<endl;
            cout<<"Do you want to search again (Y/N)";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                search();
...
void sbypubcom(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no books with publication company  ' "<<company<<" ' in the library"<<endl;
            cout<<"Do you want to search again (Y/N)";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                search();
...
void sbypubyear(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no books which was published in the year ' "<<yr<<" ' in the library"<<endl;
            cout<<"Do you want to search again (Y/N)";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                search();
...
void sort(void)
{
	system("cls");
	   ...
	   cout <<setw( 27 )<< "SORTING THE DATA..."<<endl
          << setw( 52 )<< "Please choose one of the options below: "
...
void dbyname(void)
	{
		...
		if(found == 0)
		{
            cout<<"There is no books with name ' "<<name<<" ' in the library"<<endl;
            cout<<"Do you want to delete with different attribute (Y/N) ";
            char ch=getch();
            if(ch=='y'||ch=='Y')
                del();
            else
